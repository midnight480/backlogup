...
> **このファイルがマスター（正）です。**
> 各 AI IDE 向けのルールファイルはここから派生しています。
> 規約を変更する場合はこのファイルを更新し、各 IDE 向けファイルにも反映してください。
>
> | IDE | ファイル |
> |-----|---------|
> | Kiro | `.kiro/steering/coding-standards.md` |
> | Cursor | `.cursorrules` |
> | GitHub Copilot | `.github/copilot-instructions.md` |
> | Cline | `.clinerules` |
> | Windsurf | `.windsurfrules` |
> | Antigravity | 正式サポート時に追加予定（現在は Knowledge に手動登録） |
