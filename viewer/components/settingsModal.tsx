...
export const SettingsModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center backdrop-blur-sm" onClick={onClose}>
      <div
        className="bg-white dark:bg-slate-900 border border-outline-variant dark:border-slate-700 rounded-2xl shadow-2xl w-[480px] flex flex-col overflow-hidden"
        ...
        <div className="p-6 space-y-8 flex-1 overflow-y-auto">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <label
                className={`flex-1 flex flex-col items-center justify-center p-4 rounded-xl border-2 cursor-pointer transition-all ${lang === "en" ? "border-primary bg-primary/5 text-primary" : "border-surface-container hover:border-primary/50 dark:border-slate-700"}`}
              >
              ...
              <label
                className={`flex-1 flex flex-col items-center justify-center p-4 rounded-xl border-2 cursor-pointer transition-all ${lang === "ja" ? "border-primary bg-primary/5 text-primary" : "border-surface-container hover:border-primary/50 dark:border-slate-700"}`}
              >
          ...
          <div>
            ...
            <div className="flex gap-4">
              <label
                className={`flex-1 flex flex-col items-center justify-center p-4 rounded-xl border-2 cursor-pointer transition-all ${theme === "light" ? "border-primary bg-primary/5 text-primary" : "border-surface-container hover:border-primary/50 dark:border-slate-700 dark:text-white"}`}
              >
              ...
              <label
                className={`flex-1 flex flex-col items-center justify-center p-4 rounded-xl border-2 cursor-pointer transition-all ${theme === "dark" ? "border-primary bg-primary/5 text-primary" : "border-surface-container hover:border-primary/50 dark:border-slate-700 dark:text-white"}`}
              >
